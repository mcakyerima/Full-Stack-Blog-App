...
const PostDetails = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8 lg:mr-10">
        ...
        <div className="px-4 lg:px-0">
            <div className="flex items-center mb-8 w-full">
                <div className="flex items-center  mb-5 lg:mb-0 w-full lg:w-auto mr-8">
                    <img
                ...
                <div className="font-medium text-gray-500 w-[50%]">
